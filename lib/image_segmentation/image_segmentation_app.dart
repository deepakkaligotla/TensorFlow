...
import 'package:tensorflow/image_segmentation/helper/image_segmentation_helper.dart';
import 'dart:ui' as ui;
import 'package:tensorflow/main.dart';

class ImageSegmentationApp extends StatefulWidget {
  const ImageSegmentationApp({super.key, required this.title});
  final String title;

  @override
  State<ImageSegmentationApp> createState() => _ImageSegmentationAppState();
}

class _ImageSegmentationAppState extends State<ImageSegmentationApp> with WidgetsBindingObserver {
